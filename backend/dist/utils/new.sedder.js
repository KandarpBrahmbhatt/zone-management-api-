...
const markuppersentage_model_1 = __importDefault(require("../models/markuppersentage.model"));
...
const seedDatabase = async () => {
    try {
        ...
        // Clear old data
        await markuppersentage_model_1.default.deleteMany();
        await deliveryZonePrice_model_1.default.deleteMany();
        ...
        for (let i = 0; i < TOTAL_COUNTRIES; i += BATCH_SIZE) {
            ...
            const countries = await country_model_1.default.insertMany(countryData, { ordered: false, });
            ...
            const prefixes = await deliveryPostCodePrifix_model_1.default.insertMany(prefixData, {
                ordered: false,
            });
            ...
            const prices = await deliveryZonePrice_model_1.default.insertMany(zonePriceData, {
                ordered: false,
            });
            ...
            await markuppersentage_model_1.default.insertMany(markupData, {
                ordered: false,
            });
